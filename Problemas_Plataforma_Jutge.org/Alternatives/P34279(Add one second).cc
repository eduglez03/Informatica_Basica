...
void imprimirdatos (int horas, int minutos, int segundos) {
  std::cout.fill ('0'); std::cout.width (2); std::cout << horas << ":";
  std::cout.fill ('0'); std::cout.width (2); std::cout << minutos << ":";
  std::cout.fill ('0'); std::cout.width (2); std::cout << segundos << std::endl;
}
...
int main() {
  ...
  imprimirdatos(horas, minutos, nuevos_segundos);
